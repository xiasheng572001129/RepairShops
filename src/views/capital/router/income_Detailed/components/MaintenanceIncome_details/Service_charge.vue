    ...
    <div class='Service_charge cft'>
        ...
        <div class='table'>
            <el-table :data="tableData" style="width: 100%" :max-height="screenHeight">
                ...
                <el-table-column prop="hour_charge" label="工时费(元)"  align="center"></el-table-column>
                <el-table-column prop="create_time" label="服务时间"  align="center"></el-table-column>
            </el-table>
        </div>
        <div class='total'>
...
<script>
    import { getServiceList } from '@/server/serverData'
