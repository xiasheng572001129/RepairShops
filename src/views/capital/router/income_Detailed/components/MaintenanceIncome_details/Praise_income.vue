    ...
    <div class='Praise_income'>
        ...
        <div class='table'>
            <el-table :data="tableData" style="width: 100%" :max-height="screenHeight">
                ...
                <el-table-column prop="money" label="好评奖励(元)"  align="center"></el-table-column>
...
<script>
    import { getGoodList } from '@/server/serverData'
