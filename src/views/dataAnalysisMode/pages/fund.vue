...
import { getFundAllD, getTrendListD } from "@/server/serverData";
export default {
  data() {
    return {
      lineData: "",
      ...
      var option = {
        ...
        series: [
          ...
          },
          {
            ...
            type: "pie",
            radius: ["40%", "70%"],
            color: ["#801FDE", "#FF6E6E", "#2B60FF", "#FF4B3C", "#2B60FF"],
            label: {
              normal: {
                position: "inside",
                formatter: "{d}%",
  ...
  methods: {
    ...
    async getTrendList() {
      ...
      let res = await getTrendListD(this.selectValue, startTime, endTime);
      if (res.data.code == 1) {
