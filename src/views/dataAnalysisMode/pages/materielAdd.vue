<template>
  <div class="bottomBox">
    <div class="leftChart">
      ...
      <pieChart @clickChart="clickChart" :pieData="fundOpt"></pieChart>
    </div>
...
export default {
  ...
  methods: {
    clickChart(param) { 
      // 
      if((param.name =='总补充') || (param.name =='30粘度' )|| (param.name == '40粘度')){
        return false;
      }
      // 
    ...
    async embody() {
      ...
      let res = await embodyD(this.selectValue, startTime, endTime);
      if (res.data.code == 1) {
