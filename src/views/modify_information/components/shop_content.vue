                ...
                <div class='Put_forward'>
                    ...
                    <div>
                        <table>
                            <tr>
                                <td>开户名:</td>
                                <td> <el-input disabled v-model='shopInfoList.account_name'></el-input></td>
                                <td @click="setModify" class='col-FF2828 margin-left30'>修改</td>
                            </tr>
                            <tr>
                                <td>账户号:</td>
                                <td> <el-input disabled v-model='shopInfoList.account'></el-input></td>
                            </tr>
                            <tr>
                                <td>开户行:</td>
                                <td>
                                    <el-select disabled placeholder="请选择"  v-model='shopInfoList.bank_name' @change='getBankID'>
                            ...
                            <tr>
                                <td>分行:</td>
                                <td> <el-input disabled v-model='shopInfoList.branch'></el-input></td>
                            </tr>
                        </table>
                    </div>
                </div>
