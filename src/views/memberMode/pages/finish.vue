        ...
        <div class="viewMain"> 
          <div class="secondBody">  
            ...
            <el-table :data="tableData" :header-cell-style="{background: '#D7E1E6',color: '#32373C'}">  
              ...
              <el-table-column prop="name" label="更换时间" align="center" >
              </el-table-column>
              <el-table-column prop="date" label="服务项" align="center" >
              </el-table-column>  
              <el-table-column prop="name" label="产品名称" align="center">
              </el-table-column>
              <el-table-column prop="date" label="产品品牌" align="center" >
              </el-table-column>
              <el-table-column prop="date" label="产品型号" align="center" >
              </el-table-column>
            ...
            <el-pagination class="page" background layout="prev, pager, next" 
              @current-change="qingqiushuju" :current-page.sync="dangqianpage" :page-count=totalpage >
            </el-pagination>
          </div>
        </div>  
    </div>
